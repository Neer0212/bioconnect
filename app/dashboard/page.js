          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
              {[
                ...
                { title: "Research Papers", desc: "Browse scientific publications from the community", href: "/research", emoji: "📄", cta: "Browse papers →", color: "#A855F7" },
                ...
                <a key={c.title} href={c.href} style={{ textDecoration: "none" }}>
                  <div style={{ background: "#fff", border: "1px solid #e7e5e4", borderRadius: "14px", padding: "28px 24px", transition: "all 0.3s", cursor: "pointer", height: "100%" }}>
